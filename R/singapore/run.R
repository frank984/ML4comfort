...
#hw
air5_sarima_res=CV_STkr(5,air5_hw_sarima$residual,locations)

air5_hw_tkr$residuals=select(air5_hw_tkr$residuals,subset=-c(knot,indx))
air5_tkr_res=CV_STkr(5,air5_hw_tkr$residuals,locations)

air5_SDEM_res=CV_STkr(5,air5_hw_SDEM$residuals,locations)
air5_naive_res=CV_STkr(5,air5_hw_naive$residuals,locations)

air10_sarima_res=CV_STkr(5,air10_hw_sarima$residuals,locations)

air10_hw_tkr$residuals=select(air10_hw_tkr$residuals,subset=-c(knot,indx))
air10_tkr_res=CV_STkr(5,air10_hw_tkr$residuals,locations)

air10_SDEM_res=CV_STkr(5,air10_hw_SDEM$residuals,locations)
air10_naive_res=CV_STkr(5,air10_hw_naive$residuals,locations)

air20_sarima_res=CV_STkr(5,air20_hw_sarima$residuals,locations)

air20_hw_tkr$residuals=select(air20_hw_tkr$residuals,subset=-c(knot,indx))
air20_tkr_res=CV_STkr(5,air20_hw_tkr$residuals,locations)

air20_SDEM_res=CV_STkr(5,air20_hw_SDEM$residuals,locations)
air20_naive_res=CV_STkr(5,air20_hw_naive$residuals,locations)

# 5.1) Recover original structure ---------------------------------------------------------------
air5_sarima_res$step2$stkgr@data$var1.pred=
  air5_sarima_res$step2$stkgr@data$var1.pred
+
  # weighted average of
  air5_hw_sarima$season
+
  #weighted average of
  air5_hw_sarima$trend
# 5.2) RMSE ---------------------------------------------------------------

air5_sarima_res$RMSE
