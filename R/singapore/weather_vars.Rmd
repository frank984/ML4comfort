...
air_kriged=cbind(air_kriged1,air_kriged2)
...
rainfall_kriged=cbind(rainfall_kriged1,rainfall_kriged2)
...
RH_kriged=cbind(RH_kriged1,RH_kriged2)
...
wind_speed_kriged=cbind(wind_speed_kriged1,wind_speed_kriged2)
...
wind_dir_kriged=cbind(wind_dir_kriged1,wind_dir_kriged2)
...
B=rbind(x_kriged,x_kriged2)

st=Sys.time()
air_match=match_krg_weath_coz(df_cozie,x_kriged,var_name)
en=Sys.time()
en-st
```
